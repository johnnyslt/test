...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ALICORNQ)
extern struct cpufreq_governor cpufreq_gov_alicornq;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_alicornq)
